...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private ArrayList<Person> _patientsRegistered;
    private MyPQ _myPQ;
    ...
    public MainJFrame() {
        ...
        _patientsRegistered = new ArrayList<>();
        _myPQ = new MyPQ();
    }
    ...
    private void initComponents() {
        ...
        jButtonAdd4.setText("Patients to be scheduled");
        jButtonAdd4.setToolTipText("");
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        String ageAsString = jTextFieldAge.getText();

        if (name == null || name.length() == 0) {
            this.showMessage("Please enter a patient name");
            return;
        }

        if (ageAsString == null || "".equals(ageAsString)) {
            this.showMessage("Please enter the patient's age");
            return;
        }
        ...
        if (age < 0) {
            this.showMessage("Please enter a patient age greter than zero");
            return;
        }

        Person person = new Person(name, age, jCheckBoxMedicalCondition.isSelected());
        _patientsRegistered.add(person);

        this.appendTextToTextArea("Person added: ");
        this.appendTextToTextArea(person.toString());
    ...
    private void jButtonAddShowHowManyRegisteredActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddShowHowManyRegisteredActionPerformed
        this.appendTextToTextArea("Patients registered: " + _patientsRegistered.size());
    ...
    private void jButtonAllocatePrioritiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAllocatePrioritiesActionPerformed
        for (Person person : _patientsRegistered) {
            _myPQ.allocateInPriorityQueue(person);
        }
    ...
    private void jButtonListAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListAllActionPerformed
        ...
        if(_patientsRegistered.size() == 0){
        this.showMessage("There are not registered patients");
        }
